  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      <div className="prose text-gray-500 space-y-6">
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">What We Do</h2>
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">Built by a Nigerian Student</h2>
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">Contact Us</h2>
