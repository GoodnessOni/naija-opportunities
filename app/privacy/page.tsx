export default function PrivacyPage() {
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      <p className="style={{ color: 'var(--muted-text)' }} mb-8">Last updated: May 2026</p>
      ...
      <div className="space-y-8 style={{ color: 'var(--muted-text)' }}">
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">3. How We Use Information</h2>
          <ul className="space-y-2 list-disc list-inside">
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">4. Advertising</h2>
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">5. Third Party Links</h2>
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">6. Cookies</h2>
        ...
        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">7. Data Retention</h2>
          <p>We do not store personal data beyond what is necessary. Contact form submissions are deleted after 90 days.</p>
        </div>

        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">8. Your Rights</h2>
          <p>You have the right to request deletion of any personal data we hold about you. Contact us at the email below.</p>
        </div>

        <div>
          <h2 className="text-xl font-bold style={{ color: 'var(--foreground)' }} mb-3">9. Contact</h2>
